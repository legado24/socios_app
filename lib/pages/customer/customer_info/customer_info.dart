...
class DatosCustomerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments
        as CustomerParameterPageScreen;
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          leading: IconButton(
        ...
        body: LayoutBuilder(builder: (_, constraint) {
          return Padding(
            ...
            child: BlocConsumer<CustomerInfoBloc, CustomerInfoState>(
              bloc: BlocProvider.of<CustomerInfoBloc>(
                  context)..add(CustomerInfoEvent.callInfoCustomer("DIAZPJOS", args.codCliente)),
              ...
              builder: (context, state) {
                return state.when(
                    ...
                    data: (customerInfo) => SingleChildScrollView(
                      child: Column(
                            children: [
                               Container(
                                    child: Column(
                                  ...
                                  height: 10,
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                    "${customerInfo.customer.getCellPhone ?? '-'}",
                                                    style: TextStyle(
                                                        color: Colors.grey[700],
                                                        fontWeight: FontWeight.bold,
                                                        fontFamily: "Poppins")),
